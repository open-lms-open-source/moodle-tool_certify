...
/**
 * Advanced primary menu Certification catalogue tests.
 *
 * @group      openlms
 ...
 *
 * @coversDefaultClass \tool_certify\local\navmenu\tool_certify_catalogue
 */
final class tool_certify_catalogue_test extends \advanced_testcase {
    ...
    public function test_is_parentable() {
        $this->assertFalse(tool_certify_catalogue::is_parentable());
    }

    public function test_is_editable() {
        $this->assertTrue(tool_certify_catalogue::is_editable());
    }

    public function test_get_type_name() {
        $this->assertSame('Certification catalogue', tool_certify_catalogue::get_type_name());
    }
    ...
    public function test_create() {
        ...
        $home1 = tool_certify_catalogue::create([]);
        $this->assertInstanceOf('stdClass', $home1);
        $this->assertSame('tool_certify_catalogue', $home1->itemtype);
        ...
        $home4 = tool_certify_catalogue::create([]);
        $home1 = $DB->get_record('local_navmenu_items', ['id' => $home1->id], '*', MUST_EXIST);
        $home2 = $DB->get_record('local_navmenu_items', ['id' => $home2->id], '*', MUST_EXIST);
    ...
    public function test_update() {
        ...
        $home1 = tool_certify_catalogue::create($data);
        ...
        $home1 = tool_certify_catalogue::update($data);
        $this->assertInstanceOf('stdClass', $home1);
        $this->assertSame('tool_certify_catalogue', $home1->itemtype);
        ...
        $home2 = tool_certify_catalogue::update($data);
        $home1 = $DB->get_record('local_navmenu_items', ['id' => $home1->id], '*', MUST_EXIST);
    ...
    public function test_is_visible() {
        $record = tool_certify_catalogue::create([]);
        ...
        $record = tool_certify_catalogue::update($data);
    ...
    public function test_get_name() {
        ...
        tool_certify_catalogue::create($data);
        $root = root::init();
        $item = $root->get_children()[0];
    ...
    public function test_get_url() {
        ...
        tool_certify_catalogue::create([]);
        $root = root::init();
        $item = $root->get_children()[0];

        $this->assertSame("$CFG->wwwroot/admin/tool/certify/catalogue/index.php", $item->get_url());
    }
    ...
    public function test_export_for_template() {
        ...
        $this->assertSame([
            ...
            'url' => "$CFG->wwwroot/admin/tool/certify/catalogue/index.php",
            'is_action_link' => true,
