...
/**
 * Advanced primary menu My certifications tests.
 *
 * @group      openlms
 ...
 *
 * @coversDefaultClass \tool_certify\local\navmenu\tool_certify_mycertifications
 */
final class tool_certify_mycertifications_test extends \advanced_testcase {
    ...
    public function test_is_parentable() {
        $this->assertFalse(tool_certify_mycertifications::is_parentable());
    }

    public function test_is_editable() {
        $this->assertTrue(tool_certify_mycertifications::is_editable());
    }

    public function test_get_type_name() {
        $this->assertSame('My certifications', tool_certify_mycertifications::get_type_name());
    }
    ...
    public function test_create() {
        ...
        $home1 = tool_certify_mycertifications::create([]);
        $this->assertInstanceOf('stdClass', $home1);
        $this->assertSame('tool_certify_mycertifications', $home1->itemtype);
        ...
        $home2 = tool_certify_mycertifications::create($data);
        $home1 = $DB->get_record('local_navmenu_items', ['id' => $home1->id], '*', MUST_EXIST);
        $this->assertInstanceOf('stdClass', $home2);
        $this->assertSame('tool_certify_mycertifications', $home2->itemtype);
        ...
        $home3 = tool_certify_mycertifications::create($data);
        $home1 = $DB->get_record('local_navmenu_items', ['id' => $home1->id], '*', MUST_EXIST);
        $home2 = $DB->get_record('local_navmenu_items', ['id' => $home2->id], '*', MUST_EXIST);
        $this->assertInstanceOf('stdClass', $home3);
        $this->assertSame('tool_certify_mycertifications', $home3->itemtype);
        ...
        $home4 = tool_certify_mycertifications::create([]);
        $home1 = $DB->get_record('local_navmenu_items', ['id' => $home1->id], '*', MUST_EXIST);
        $home2 = $DB->get_record('local_navmenu_items', ['id' => $home2->id], '*', MUST_EXIST);
    ...
    public function test_update() {
        ...
        $home1 = tool_certify_mycertifications::create($data);
        ...
        $home1 = tool_certify_mycertifications::update($data);
        $this->assertInstanceOf('stdClass', $home1);
        $this->assertSame('tool_certify_mycertifications', $home1->itemtype);
        ...
        $home2 = tool_certify_mycertifications::update($data);
        $home1 = $DB->get_record('local_navmenu_items', ['id' => $home1->id], '*', MUST_EXIST);
    ...
    public function test_is_visible() {
        $record = tool_certify_mycertifications::create([]);
        ...
        $record = tool_certify_mycertifications::update($data);
    ...
    public function test_get_name() {
        $data = [
            'name' => 'Certifikace 1<span>xx</span>',
        ];
        tool_certify_mycertifications::create($data);
        $root = root::init();
        $item = $root->get_children()[0];
    ...
    public function test_get_url() {
        ...
        tool_certify_mycertifications::create([]);
        $root = root::init();
        $item = $root->get_children()[0];

        $this->assertSame("$CFG->wwwroot/admin/tool/certify/my/index.php", $item->get_url());
    }
    ...
    public function test_export_for_template() {
        ...
        $this->assertSame([
            ...
            'url' => "$CFG->wwwroot/admin/tool/certify/my/index.php",
            'is_action_link' => true,
