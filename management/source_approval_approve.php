...
$currenturl = new moodle_url('/admin/tool/certify/management/source_approval_approve.php', ['id' => $id]);
...
$form = new \tool_certify\local\form\source_approval_approve(null, ['request' => $request, 'user' => $user, 'certification' => $certification, 'context' => $context]);
...
if ($data = $form->get_data()) {
    tool_certify\local\source\approval::approve_request($request->id);
