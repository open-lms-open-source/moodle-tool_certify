...
$currenturl = new moodle_url('/admin/tool/certify/management/certification_settings_edit1.php', ['id' => $id]);

management::setup_certification_page($currenturl, $context, $certification);

$form = new \tool_certify\local\form\certification_settings_edit1(null, ['certification' => $certification, 'context' => $context]);
