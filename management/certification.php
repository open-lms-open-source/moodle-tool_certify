...
$currenturl = new moodle_url('/admin/tool/certify/management/certification.php', ['id' => $id]);

management::setup_certification_page($currenturl, $context, $certification);
//$PAGE->set_docs_path("$CFG->wwwroot/admin/tool/certify/documentation.php/certification_general.md");
...
$buttons = [];
if ($certification->archived && has_capability('tool/certify:delete', $context)) {
    $url = new moodle_url('/admin/tool/certify/management/certification_delete.php', ['id' => $certification->id]);
    $deletebutton = new local_openlms\output\dialog_form\button($url, get_string('deletecertification', 'tool_certify'));
...
if (has_capability('tool/certify:edit', $context)) {
    $url = new moodle_url('/admin/tool/certify/management/certification_update.php', ['id' => $certification->id]);
