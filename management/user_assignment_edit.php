...
$currenturl = new moodle_url('/admin/tool/certify/management/user_assignment_edit.php', ['id' => $assignment->id]);

management::setup_certification_page($currenturl, $context, $certification);

$form = new \tool_certify\local\form\user_assignment_edit(null,
