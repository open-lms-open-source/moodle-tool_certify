...
$currenturl = new moodle_url('/admin/tool/certify/management/certification_visibility_edit.php', ['id' => $id]);
...
$form = new \tool_certify\local\form\certification_visibility_edit(null, ['data' => $current, 'context' => $context]);

$returnurl = new moodle_url('/admin/tool/certify/management/certification_visibility.php', ['id' => $certification->id]);
