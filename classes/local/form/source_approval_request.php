...
final class source_approval_request extends \local_openlms\dialog_form {
    protected function definition() {
        ...
        $confirmation = markdown_to_html(get_string('source_approval_confirm', 'tool_certify'));
        ...
        $this->add_action_buttons(true, get_string('source_approval_makerequest', 'tool_certify'));
    }
