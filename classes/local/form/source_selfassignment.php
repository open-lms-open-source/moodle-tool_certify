 ...
 */
final class source_selfassignment extends \local_openlms\dialog_form {
    protected function definition() {
        ...
        $confirmation = markdown_to_html(get_string('source_selfassignment_confirm', 'tool_certify'));
        $mform->addElement('static', 'confirmation', '', clean_text($confirmation));

        $data = (object)json_decode($source->datajson);
        if (isset($data->key)) {
            $mform->addElement('passwordunmask', 'key', get_string('source_selfassignment_key', 'tool_certify'));
        ...
        $this->add_action_buttons(true, get_string('source_selfassignment_assign', 'tool_certify'));
    }
