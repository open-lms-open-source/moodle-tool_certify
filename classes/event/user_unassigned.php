...
final class user_unassigned extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_user_unassigned', 'tool_certify');
    }
    ...
    public function get_url() {
        return new \moodle_url('/admin/tool/certify/management/certification.php', ['id' => $this->other['certificationid']]);
    }
